...
<figure>
  <Image src={terraIcons} alt="Excerpt from the One Cerner Style icon library: status, care and workflow icons in the upper section, navigation, communication and reference icons below." loading="lazy" decoding="async" widths={[640, 960, 1280, 1920]} sizes="(min-width: 1280px) 1280px, 100vw" />
