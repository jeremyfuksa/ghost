...
<figure>
  <img src="/images/object-id-name-formatting.jpg" alt="Object ID name-formatting rules: a seven-step truncation ladder from a full multi-part name down to family-name-only, with example patient cards at each step." width="1920" height="1080" loading="lazy" decoding="async" />
  <figcaption>Object ID — name formatting and truncation steps.</figcaption>
</figure>

<figure>
  <img src="/images/object-id-age-calculation.jpg" alt="Object ID age-calculation rules: pediatric and standard age thresholds spanning minutes, hours, days, weeks, months, and years." width="1920" height="1080" loading="lazy" decoding="async" />
  <figcaption>Object ID — health-aware age calculation thresholds.</figcaption>
</figure>

<figure>
  <img src="/images/object-id-gender-mismatch.jpg" alt="Object ID sex and gender display: a patient card highlighting the sex and pronouns field, with optional displays for label, mismatch indicator, and pronouns." width="1920" height="680" loading="lazy" decoding="async" />
  <figcaption>Object ID — sex and gender display configuration.</figcaption>
</figure>
