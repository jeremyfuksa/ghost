...
<figure>
  <Image src={nameFormatting} alt="Object ID name-formatting rules: a seven-step truncation ladder from a full multi-part name down to family-name-only, with example patient cards at each step." loading="lazy" decoding="async" widths={[640, 960, 1280, 1920]} sizes="(min-width: 1280px) 1280px, 100vw" />
  <figcaption>Object ID — name formatting and truncation steps.</figcaption>
</figure>

<figure>
  <Image src={ageCalculation} alt="Object ID age-calculation rules: pediatric and standard age thresholds spanning minutes, hours, days, weeks, months, and years." loading="lazy" decoding="async" widths={[640, 960, 1280, 1920]} sizes="(min-width: 1280px) 1280px, 100vw" />
  <figcaption>Object ID — health-aware age calculation thresholds.</figcaption>
</figure>

<figure>
  <Image src={genderMismatch} alt="Object ID sex and gender display: a patient card highlighting the sex and pronouns field, with optional displays for label, mismatch indicator, and pronouns." loading="lazy" decoding="async" widths={[640, 960, 1280, 1920]} sizes="(min-width: 1280px) 1280px, 100vw" />
