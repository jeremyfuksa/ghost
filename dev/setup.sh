...
<p>So the architecture\u2019s promise \u2014 accessible, internationalized, responsive components built once, consumed everywhere \u2014 only works if the components faithfully implement those standards. Catching the gaps took someone who could read the design standards and the pull request side by side, and push back on the difference.</p>
...
<p>Alongside that, I owned the <a href="https://github.com/oracle-samples/one-cerner-style-icons">icon library</a> \u2014 a dedicated Git repository the engineering team consumed into the component system, maintained end-to-end from design asset to published package (<a href="https://engineering.cerner.com/blog/one-cerner-style-icons/">UX write-up</a>).</p>
...
<p>The gap between what the standard says and what the engineer built in good faith was rarely about bad standards or bad engineering. By the time I got to Terra, the standards were mature and thoroughly written. The gap was unstated context \u2014 the situation in front of the engineer that the standard couldn\u2019t anticipate.</p>
<p>The other thing I learned was personal. I came up on the web believing <a href="https://zeldman.com/">Jeffrey Zeldman\u2019s</a> line that real designers code \u2014 it had been true everywhere I\u2019d worked. Enterprise was where I learned it wasn\u2019t the default anymore. Design and engineering were separate disciplines, and plenty of designers on my team didn\u2019t write CSS, let alone read React. Being one of two designers on Terra who could work in the codebase surprised me \u2014 I\u2019d figured that at a tech company code came with the territory, and instead it had become a specialty.</p>
<h2>What happened next</h2>
<p>In mid-2022 I moved from the hands-in-code IC role into design management at Cerner, eventually leading up to 12 designers across the US and India. A few months later, Oracle completed its $28.3 billion acquisition of Cerner.</p>
<p>The management philosophy shifted fast: design managers were now expected to deliver meaningful IC work on top of leading. The IC project I took on was the Redwood theme for Terra \u2014 a reskin of the component library in Oracle\u2019s Redwood design language so Oracle-built apps could drop into Millennium. Two months in, Oracle Health decided to rebuild its applications from the ground up instead. The bridge became moot.</p>
<p>That ended my Terra chapter. The leadership story and the Redwood design work that came next are each their own case studies. Both start here.</p>"""
